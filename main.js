...
function pagarClicked(){
    alert("Gracias por la compra,escríbenos para realizar las coordinaciones");
...
// Agrega un evento "submit" al elemento con el ID "registroForm"
document.getElementById("registroForm").addEventListener("submit", function(event) {
  // Previene el envío del formulario por defecto
    event.preventDefault();
    
  // Obtén los valores del formulario
    // Obtiene el valor del campo de entrada con el ID "nombre" y lo asigna a la variable "nombre"
